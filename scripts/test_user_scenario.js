...
async function runTestScenario() {
  ...
  try {
    ...
    // Dynamic import of binary library for execution
    // (We will use direct functions or creditPurchasePV)
    const { creditPurchasePV } = require("../src/lib/binary");
    ...
    const { checkRoyaltyQualification, getMonthlyRoyaltyPool } = require("../src/lib/royalty");
