...
export default function MemberSidebar({ user, onLogout, onNavigate }: MemberSidebarProps) {
  ...
  // Exact 5 Categories requested:
  // 1. Dashboard
  // 2. Shopping Portal (- shopping - cart - past orders)
  // 3. Network (- tree - direct referral - total team)
  // 4. Income Report (- binary income)
  // 5. Account & Support (- myprofile - kyc - change password - help)
  const menuGroups = [
    {
